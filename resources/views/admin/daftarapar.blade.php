...
<div class="flex flex-row items-center justify-between w-full mb-4">
    <div class="flex items-center gap-2">
        ...
        <!-- Dropdown -->
        <div class="relative">
            <button id="dropdownButton" class="bg-white border border-black px-4 py-2 rounded-lg flex items-center space-x-2 text-gray-700">
            <span id="dropdownText" class="truncate">Tipe</span>
            ...
            <div id="dropdownMenu" class="absolute right-0 mt-2 w-40 bg-white border border-gray-300 shadow-lg rounded-lg hidden overflow-hidden">
        <ul class="py-2">
