...
@section('content')
    ...
    <div class="flex items-center mb-6">
        ...
        <!-- Page Title -->
        <h1 class="text-lg font-bold text-gray-800 ">Detail Riwayat</h1>
    </div>

    <div class="bg-white shadow-md rounded-lg p-6 w-full -mt-4 
            h-[770px] sm:h-[800px] md:h-[350px] ">
    <!-- Title with Icons -->
    <div class="flex justify-between items-center mb-4 -mt-4">
        <h2 class="text-xl font-bold">Pengecekan Agustus 2024</h2>
