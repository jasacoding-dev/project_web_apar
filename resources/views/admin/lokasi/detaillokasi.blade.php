    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-between items-center mb-4 -mt-3">
            ...
            <div class="flex -space-x-2">
                <!-- Edit Button -->
                <a href="{{ route('lokasi.edit', ['id' => $lokasi->id]) }}"
                ...
                <div
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6 w-96 text-center relative">
                        ...
                        <div class="flex justify-center space-x-4">
                            ...
                            <button class="bg-[#FFDF00] text-black font-semibold px-4 py-1 w-40 rounded-lg" onclick="handleDelete('{{ $lokasi->id }}')">
                                Ya
                            </button>
                        ...
                        fetch(`/admin/lokasi/${id}`, {
                            ...
                            .then(response => {
                                if (response.ok) {
                                    ...
                                    setTimeout(() => {
                                        window.location.href = "{{ route('lokasi.index') }}"; // Redirect ke halaman index
                                    }, 2000);
                                } else {
