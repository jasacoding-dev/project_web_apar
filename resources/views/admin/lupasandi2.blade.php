...
<div class="mb-1 sm:mb-2">
    ...
    <div class="relative group">
        ...
        group-hover:border-gray-400 focus:border-gray-400 transition duration-200">
        <button type="button" class="absolute inset-y-0 right-2 flex items-center text-gray-500 hover:text-blue-500" 
            onclick="togglePassword('katasandi', 'eye2')">
        ...
        <div class="mt-8 sm:mt-2 text-center">
            <button type="submit" class="w-full sm:w-80  text-center bg-yellow-400 text-black font-bold py-2 rounded-lg hover:bg-yellow-500">
                Selanjutnya
            </button>
        </div>
