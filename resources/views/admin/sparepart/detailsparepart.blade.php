...
<div class="flex items-center mt-20 mb-2 ml-4"> <!-- Tambahkan mb-2 untuk mengurangi jarak bawah -->
    <a href="{{ route('sparepart.index') }}" class="flex items-center text-gray-700 hover:text-gray-900">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
        </svg>
        <span class="text-lg font-semibold">Detail Sparepart</span>
    </a>
</div>
...
<main class="p-6 -mt-4 max-w-full mx-auto"> <!-- mt-4 untuk mendekatkan ke tombol back -->
    <div class="bg-white p-6 rounded-lg shadow-lg ">
        ...
        <div class="flex justify-between items-center mb-4 -mt-3">
            <h2 class="text-xl font-bold">Informasi Sparepaart</h2>
                ...
                <div
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6 w-96 text-center relative">
                        ...
                        <div class="flex justify-center space-x-4">
                            ...
                            <button class="bg-[#FFDF00] text-black font-semibold px-4 py-1 w-40 rounded-lg" onclick="handleDelete('{{ $sparepart->id }}')">
                                Ya
                            </button>
                        ...
                        fetch(`/admin/sparepart/${id}`, {
                            ...
                            .then(response => {
                                if (response.ok) {
                                    ...
                                    setTimeout(() => {
                                        window.location.href = "{{ route('sparepart.index') }}"; // Redirect ke halaman index
                                    }, 2000);
                                } else {
        ...
        <div class="flex flex-col md:flex-row gap-4">
            ...
            <div class="pr-8 md:pr-16 text-sm flex-1">
                <div class="mb-4">
                    ...
                    <p>{{ $sparepart->nomor_sparepart }}</p>
                </div>
                <div class="mb-4">
                    <p class="font-bold">Merek</p>
                    <p>{{ $sparepart->nama_sparepart }}</p>
                </div>
                <div class="mb-4">
                    <p class="font-bold">Foto</p>
                    <img src="{{ asset('storage/spareparts/' . $sparepart->foto) }}" alt="APAR" class="w-40 h-40 rounded-lg shadow-md">
                </div>
            </div>
            ...
            <div class="pl-0 md:pl-10 text-sm mr-48 flex-1">
                <div class="mb-4">
                    ...
                    <p>{{ $sparepart->jumlah }}</p>
                </div>
                <div class="mb-4">
                    <p class="font-bold">Sistem Kerja Alat</p>
                    <p>{{ $sparepart->keterangan ?? 'Tidak ada keterangan' }}</p>
                </div>
            </div>
        </div>
    </div>
