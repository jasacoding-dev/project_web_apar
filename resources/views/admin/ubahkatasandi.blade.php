...
@section('content')
        ...
        <table class="table-auto w-full text-left border-collapse mt-2 rounded-lg overflow-hidden shadow-md">
            ...
            <div class="bg-[#0168AD] rounded-t-lg p-2 -mt-3">
                <nav class="flex justify-center space-x-4">
                    <a href="/admin/detailprofil" class="text-white hover:underline">Detail Profil</a>
   ...
   <h2 class="text-lg font-bold mb-2 sm:mb-3 text-left">Ubah Kata Sandi</h2>
    ...
    <a href="/admin/profil" class="w-full sm:w-80 inline-block text-center bg-yellow-400 text-black font-bold py-2 rounded-lg hover:bg-yellow-500">
        Selanjutnya
    </a>
</div>
