    ...
    Buat Akun
        ...
        <form class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" id="name" class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm" placeholder="Masukkan nama" required>
            </div>
            ...
            <div>
                ...
                <input type="email" id="email" class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm" placeholder="Masukkan email" required>
            </div>
...
<script>
    ...
    <div class="relative">
        ...
        <input type="password" id="password" class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm pr-10" placeholder="Masukkan kata sandi" required>
    ...
    <div class="relative">
        ...
        <input type="password" id="confirm_password" class="w-full border border-gray-300 rounded-lg py-2 px-3 text-sm pr-10" placeholder="Masukkan ulang kata sandi" required>
