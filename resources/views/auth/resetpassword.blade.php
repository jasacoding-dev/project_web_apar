...
<div class="text-center mb-4 px-6">
  ...
  <form class="w-full flex flex-col items-center">
                ...
                <div class="mb-2">
                    ...
                    <div class="relative">
                        <input type="password" id="password1" class="w-96 py-1 px-3 border border-gray-300 rounded-lg focus:outline-none" required>
                ...
                <div class="mb-2">
                    <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Konfirmasi Kata Sandi</label>
                    <div class="relative">
                        <input type="password" id="password2" class="w-96 py-1 px-3 border border-gray-300 rounded-lg focus:outline-none" required>
