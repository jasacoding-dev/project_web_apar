...
<form class="w-full flex flex-col items-center px-4 sm:px-0">
    <div class="mb-3 sm:mb-4 w-full sm:max-w-[80%] md:max-w-[380px]">
        ...
        <input type="email" id="email" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none"
...
<div class="text-center mt-4">
    <p class="text-gray-600 font-semibold text-sm">Kembali? <a href="#" class="text-[#E6C900] font-medium hover:underline">Masuk</a></p>
</div>
