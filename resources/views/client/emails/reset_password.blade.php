...
<body>
    ...
    <a href="{{ route('client.lupasandi2', ['token' => $token, 'email' => $user->email]) }}" style="background-color: #0168AD; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
        Reset Kata Sandi
    </a>
