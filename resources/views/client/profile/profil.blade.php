        ...
        <table class=" w-full text-left border-collapse mt-2 rounded-lg overflow-hidden shadow-md">
            ...
            <div class="bg-[#0168AD] rounded-t-lg p-1 -mt-3">
                <nav class="flex justify-center space-x-4">
                    <a href="{{ route('client.profile') }}" class="text-white font-semibold hover:underline">Detail Profil</a>
            ...
            <div class="bg-white shadow-md rounded-b-lg p-2">
                ...
                <div class="relative flex flex-col md:flex-row items-center pb-2 mb-6 border border-black rounded-lg p-4 -mt-2">
                    <div class="relative">
                        <!-- Foto Profil -->
                        <img src="{{ asset($user->profile_picture ? 'storage/' . $user->profile_picture : 'img/person-dummy.jpg') }}" alt="Profile Picture" class="w-16 h-16 rounded-full border mb-3 md:mb-0 md:mr-4">

                        <!-- Tombol Edit -->
                        <button onclick="document.getElementById('profile_picture').click()" class="absolute bottom-0 right-0 transform translate-x-1/4 translate-y-1/4 bg-white border border-gray-300 p-1.5 rounded-full shadow-md mr-5">
                ...
                <form action="{{ route('client.profile.updatePicture') }}" method="POST" enctype="multipart/form-data" class="hidden">
                    @csrf
                    <input class="hidden" type="file" name="profile_picture" id="profile_picture" onchange="this.form.submit()">
                </form>
