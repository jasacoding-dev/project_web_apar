...
<script>
    function toggleDropdown(menuId, iconId) {
        ...
        icon.classList.toggle("rotate-180"); // Menambah/menghapus rotasi ikon
                    ...
                    <li class="mt-4">
                        <a href="/admin/daftarbarcode" class="bg-white text-[#223E88] flex items-center px-4 text-white py-2 font-bold rounded">
                        <img src="{{ asset('storage/barcode.png') }}" alt="Icon" class="w-4 h-4 mr-2">
                        Barcode
                        </a>
                    </li>
