...
<li class="mt-4">
    ...
    <ul id="componentsDropdown" class="hidden pl-8 space-y-1">
    <li>
...
<li class="mt-4">
    <a href="/admin/daftarbarcode" class="bg-white text-[#223E88] flex items-center px-4 py-2 font-bold rounded">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2">
            <path d="M14 3V7C14 7.26522 14.1054 7.51957 14.2929 7.70711C14.4804 7.89464 14.7348 8 15 8H19" fill="#223E88"/>
