...
<body class="bg-gray-100 relative" onclick="closeSidebar(event)">
  ...
  <div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-[#223E88] text-white transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50">
        ...
        <nav class="mt-1">
        <a href="/client/dashboard" class="block px-6 py-3 mx-4 rounded-lg  text-white hover:bg-blue-700 mb-2 flex items-center">
    ...
    <a href="/client/daftarlokasi" class="bg-white block px-6 py-3 mx-4 rounded-lg text-[#223E88]  mb-2 flex items-center">
    <!-- Ikon Lokasi -->
