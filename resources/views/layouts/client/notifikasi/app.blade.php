            ...
            <div class="md:ml-64">
                ...
                <header class="fixed top-0 left-0 h-16 right-0 bg-[#223E88] shadow-md flex items-center px-6 z-40 justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        <h1 class="text-lg text-white font-bold ml-0 md:ml-64">Notifikasi</h1>
                    </div>

                    <!-- Kanan: Ikon Notifikasi dan Profil -->
                    <div class="flex items-center space-x-4">
                        <!-- Ikon Notifikasi -->
                        <a href="{{ route('client.notifications') }}" class="text-white hover:text-gray-300">
                        ...
                        <!-- Ikon Profil -->
                        <a href="{{ route('client.profile') }}" class="text-white hover:text-gray-300">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
