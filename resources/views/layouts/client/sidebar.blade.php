...
<body class="bg-gray-100 relative" onclick="closeSidebar(event)">
    ...
    <div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-[#223E88] text-white transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50">
        ...
        <nav class="mt-0">
            <a href="{{ route('client.dashboard') }}" onclick="setActiveMenu(event)" class="menu-item block px-6 py-3 mx-4 rounded-lg text-white hover:bg-blue-700 mb-2 flex items-center">
            ...
            <a href="{{ route('client.lokasi') }}" onclick="setActiveMenu(event)" class="menu-item block px-6 py-3 mx-4 rounded-lg text-white hover:bg-blue-700 mb-2 flex items-center">
                <!-- Ikon Lokasi -->
