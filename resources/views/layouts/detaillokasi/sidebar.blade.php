...
<body class="min-h-screen flex flex-col">
  <div class="flex flex-grow min-h-screen">
    <!-- Sidebar -->
    <aside id="sidebar" class="w-52 bg-[#223E88] text-white min-h-screen  md:relative hidden md:flex flex-col">
      <!-- Sidebar Content -->
...
<li class="mt-4">
                        <a href="/admin/daftarlokasi" class="bg-white text-[#223E88] flex items-center px-4 py-2 hover:bg-blue-700 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#223E88" class="w-5 h-5 mr-2">
...
<!-- Log Out -->
<li class="absolute md:bottom-72 md:left-1/2 bottom-4 left-0 md:transform md:-translate-x-1/2 w-full md:w-[98%] px-4">
