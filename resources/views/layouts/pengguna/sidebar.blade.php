  ...
  <div class="flex flex-grow min-h-screen">
    ...
    <aside id="sidebar" class="w-52 bg-[#223E88] text-white min-h-screen fixed md:relative hidden md:flex flex-col">
      ...
      <nav class="mt-4 flex-1 px-4 space-y-4 font-bold">
        <ul>
        <li>
    <a href="/admin/dashboard" class=" flex items-center px-4 py-2 rounded text-white hover:bg-blue-700">
        ...
        Beranda
          ...
          <li class="mt-4">
    <a href="/admin/pengguna" class="bg-white flex items-center px-4 text-[#223E88] py-2 font-bold rounded">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="mr-2">
            <path d="M1.66663 3.3275C1.66815 3.10865 1.75571 2.89918 1.91039 2.74435C2.06506 2.58951 2.27444 2.50175 2.49329 2.5H17.5066C17.9633 2.5 18.3333 2.87083 18.3333 3.3275V16.6725C18.3318 16.8914 18.2442 17.1008 18.0895 17.2557C17.9349 17.4105 17.7255 17.4983 17.5066 17.5H2.49329C2.27397 17.4998 2.06371 17.4125 1.9087 17.2573C1.75369 17.1022 1.66663 16.8918 1.66663 16.6725V3.3275ZM4.99996 12.5V14.1667H15V12.5H4.99996ZM4.99996 5.83333V10.8333H9.99996V5.83333H4.99996ZM11.6666 5.83333V7.5H15V5.83333H11.6666ZM11.6666 9.16667V10.8333H15V9.16667H11.6666ZM6.66663 7.5H8.33329V9.16667H6.66663V7.5Z" fill="#223E88"/>
        </svg>
        Pengguna
    </a>
</li>
...
<li class="mt-4">
    <a href="/admin/daftarlokasi" class="flex items-center px-4 py-2 hover:bg-blue-700 rounded">
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2">
            <path d="M12.9998 12.4584C12.2815 12.4584 11.5927 12.1731 11.0848 11.6652C10.5768 11.1573 10.2915 10.4684 10.2915 9.75008C10.2915 9.03179 10.5768 8.34291 11.0848 7.835C11.5927 7.32709 12.2815 7.04175 12.9998 7.04175C13.7181 7.04175 14.407 7.32709 14.9149 7.835C15.4228 8.34291 15.7082 9.03179 15.7082 9.75008C15.7082 10.1057 15.6381 10.4579 15.502 10.7865C15.3659 11.1151 15.1664 11.4137 14.9149 11.6652C14.6634 11.9167 14.3649 12.1161 14.0363 12.2523C13.7077 12.3884 13.3555 12.4584 12.9998 12.4584ZM12.9998 2.16675C10.9886 2.16675 9.05976 2.9657 7.63761 4.38786C6.21546 5.81001 5.4165 7.73886 5.4165 9.75008C5.4165 15.4376 12.9998 23.8334 12.9998 23.8334C12.9998 23.8334 20.5832 15.4376 20.5832 9.75008C20.5832 7.73886 19.7842 5.81001 18.3621 4.38786C16.9399 2.9657 15.0111 2.16675 12.9998 2.16675Z" 
            fill="white"/>
        </svg>
        Lokasi
    </a>
...
<div class="flex flex-col-reverse md:flex-row justify-center md:space-x-4 mt-6">
    <button onclick="toggleModal()" class="w-full md:w-40 lg:w-48 px-4 py-2 border border-yellow-400 text-yellow-500 rounded hover:bg-yellow-100 mt-2 md:mt-0">
        Kembali
    </button>
    <a href="/logout" class="w-full md:w-40 lg:w-48 px-4 py-2 bg-yellow-400 text-white font-bold rounded hover:bg-yellow-500 mb-2 md:mb-0">
        Ya
    </a>
</div>
</div>
