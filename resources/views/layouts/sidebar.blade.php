...
<head>
    ...
    <script>
        ...
        function setActiveMenu(event) {
            ...
            // Simpan href dari elemen yang diklik
...
<body class="bg-gray-100 relative" onclick="closeSidebar(event)">
    ...
    <div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-[#223E88] text-white transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50">
        ...
        <nav class="mt-0">
            ...
            <a href="/admin/pengguna" onclick="setActiveMenu(event)" class="menu-item block px-6 py-3 mx-4 rounded-lg text-white hover:bg-blue-700 mb-2 flex items-center">
            ...
            <div class="relative mx-6">
                <button onclick="toggleDropdown(); setActiveMenu(event)" class=" flex items-center justify-between w-full px-4 py-3 rounded-lg text-white mb-2 hover:bg-blue-700 hover:text-white">
                ...
                <div id="dropdownMenu" class="hidden">
                    <a href="/admin/daftarapar" onclick="setActiveMenu(event)" class="menu-item block px-6 py-3 pl-10 rounded-lg text-white hover:bg-blue-700 hover:text-white hover:font-bold">APAR</a>
