  ...
  <div class="flex flex-grow min-h-screen">
    ...
    <aside id="sidebar" class="w-52 bg-[#223E88] text-white min-h-screen fixed md:relative hidden md:flex flex-col">
      ...
      <nav class="mt-4 flex-1 px-4 space-y-4 font-bold">
        <ul>
          <li>
            <a href="/admin/dashboard" class="flex items-center px-4 py-2 hover:bg-blue-700 rounded text-white">
              <img src="{{ asset('storage/ke 6.png') }}" alt="Icon" class="w-5 h-5 mr-2"> Beranda
            </a>
          </li>
          <li class="mt-4">
    ...
    <button class="bg-white text-[#223E88] flex items-center justify-between w-full px-4 py-2 rounded" 
        ...
        <div class="flex items-center">
            <img src="{{ asset('storage/inventaris.png') }}" alt="Icon" class="w-5 h-5 mr-2">
            Inventaris
        </div>
...
<script>
    function toggleDropdown(menuId, iconId) {
        ...
        icon.classList.toggle("rotate-180"); // Menambah/menghapus rotasi ikon
                    ...
                    <li class="mt-4">
                        <a href="/admin/daftarbarcode" class=" flex items-center px-4 text-white py-2 hover:bg-blue-700 font-bold rounded">
