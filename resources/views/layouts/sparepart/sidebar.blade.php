...
<a href="/admin/pengguna" class=" block px-6 py-3 mx-4 rounded-lg  text-white hover:bg-blue-700   mb-2 flex items-center">
    ...
    <button onclick="toggleDropdown()" class="bg-white flex items-center justify-between w-full px-4 py-3 rounded-lg text-[#223E88] mb-2">
        ...
        <div id="dropdownMenu" class="hidden">
            ...
            <a href="/admin/daftarsparepart" class="bg-white block px-6 py-3 pl-10 rounded-lg text-[#223E88] hover:font-bold ">Sparepart</a>
        </div>
    </div>
