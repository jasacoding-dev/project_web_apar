...
<li class="mt-4">
    <button class="flex items-center justify-between w-full px-4 py-2  rounded" 
    ...
    <ul id="componentsDropdown" class="hidden pl-8 space-y-1 text-white">
        <li>
            <a href="#" class="block px-4 py-2 font-normal hover:text-white hover:bg-blue-700 rounded">Apar</a>
        </li>
        <li>
            <a href="#" class="block px-4 py-2 font-bold hover:text-white  hover:bg-blue-700 rounded">Sparepart</a>
        </li>
    </ul>
</li>
<script>
