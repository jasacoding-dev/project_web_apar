...
<head>
    ...
    <title>@yield('title', 'Barcode')</title>
    <!-- Tailwind CSS -->
            ...
            <div class="md:ml-64">
                ...
                <header class="fixed top-0 left-0 h-16 right-0 bg-[#223E88] shadow-md flex items-center px-6 z-40 justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        <h1 class="text-lg text-white font-bold ml-0 md:ml-64">Barcode</h1>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <!-- Ikon Profil -->
                        <a href="{{ route('staff.profile') }}" class="text-white hover:text-gray-300">
