...
<div class="flex flex-row items-center justify-between w-full space-x-4 mb-4">
    ...
    <!-- Add Button -->
    <a href="/staff/tambahlokasi" class="bg-[#FFDF00] text-black font-bold px-6 py-2 rounded-lg flex items-center space-x-2 whitespace-nowrap">
        <span>Tambah</span>
    </a>
</div>
    ...
    <table class="w-full border-collapse border border-gray-300">
        ...
        <tbody>
            ...
            <td class="border border-gray-300 px-4 py-2 font-bold">
                    <a href="/staff/detaillokasi" class="text-blue-500 hover:underline">111</a>
                </td>
